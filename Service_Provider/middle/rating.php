<div class="row">
    ...
    <tbody>
	<?php
	$sel = "select * from rating_tb,user_tb,serviceprovider_tb where rating_tb.u_id = user_tb.u_id and rating_tb.sp_id = serviceprovider_tb.sp_id and rating_tb.sp_id = '$_SESSION[sid]'";
