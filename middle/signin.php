  ...
  <div class="container">
   <div class="breadcrumb1">
     <ul>
        ...
        <li class="current-page">User Sign In</li>
     </ul>
   </div>
   <form method="post">
   <div class="services">
	     ...
	     <div class="form-group">
		    ...
		    <input type="text" id="edit-name" placeholder="Enter Your Email" name="a1" value="" size="60" maxlength="60" class="form-text required" required="required" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" title="Enter Valid Email" />
		      ...
		      <input type="password" id="edit-pass" placeholder="Enter Your Password" name="a2" size="60" maxlength="128" class="form-text required" required="required" />
                     ...
                     <a href="index.php?file=vendorsign"> Sign in as service provider </a>
                     <a href="index.php?file=usersignup" style='float: right'> I dont have an account! </a>
	   ...
	   if(isset($_REQUEST['submit']))
			{
			   ...
			   $sel = "select * from user_tb where u_email = '$a' and u_status='Active'";
			   $r = $con->query($sel);
			   // check row - data 
			   if(mysqli_num_rows($r) > 0)
			   {
			      while($rw= mysqli_fetch_assoc($r))
					 ...
					 $_SESSION["email"] = $a;
			         $_SESSION["uid"] = $rw['u_id'];
                                 $_SESSION["u_name"] = $rw['u_name'];
