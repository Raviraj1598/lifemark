...
if(isset($_POST["b1"]))
{
    ...
    $s_name= $link -> real_escape_string($_POST['shop_name']);
    $address= $link -> real_escape_string($_POST['address']);
    
    $qry="update serviceprovider_tb set shop_name='$s_name',sp_name='$name',bio='$bio',sp_contact='$contact',shop_address='$address' where sp_id='$sp_id'";
...
if(isset($_POST["change_pass"]))
{
    ...
    { 
         ...
         if($npass==$pass->pp)
         {
              ...
              $qry="update serviceprovider_tb set sp_password='$npass',hash='$salt' where sp_id='$uid'";
              mysqli_query($link, $qry);
  ...
  if(isset($_FILES["dp"]) && $_FILES["dp"]["size"]>0)
            {
                ...
                move_uploaded_file($_FILES["dp"]["tmp_name"],"../upload/shop/$fname");
             
                $qry="update serviceprovider_tb set shop_image='$fname' where sp_id='".$data->id."'";
                mysqli_query($link, $qry);
...
if(isset($_REQUEST["delaccount"]))
{
  $qry="delete from serviceprovider_tb where sp_id='".$data->id."'";
  mysqli_query($link, $qry);
        ...
        <div class="row gx-4">
          <div class="col-auto">
            <div class="avatar avatar-xl position-relative">
                <img src="../upload/shop/<?php echo $data -> dp; ?>" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
            </div>
          </div>
      ...
      <div class="row">
          ...
          <div class="card h-100">
            ...
            <div class="card-body p-3">
              ...
              <ul class="list-group">
                <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Userame:</strong> &nbsp; <?php echo $data -> name; ?></li>
                <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Shop Name:</strong> &nbsp; <?php echo $data -> shop_name; ?></li>
          ...
          <div class="card h-100">
            ...
            <div class="card-body p-3">
                ...
                <div class="mb-3">
                 ...
                 <div class="mb-3">
                  <input name="name" type="text" class="form-control" placeholder="Username" value="<?php echo $data -> name; ?>">
                </div> 
                      <div class="mb-3">
                  <input name="shop_name" type="text" class="form-control" placeholder="Shop Name" value="<?php echo $data -> shop_name; ?>">
                </div> 
                    <div class="mb-3">
                  <input name="contact" type="text" class="form-control" placeholder="Mobile Number" value="<?php echo $data -> contact; ?>">
                </div> 
                      <div class="mb-3">
                  <input name="address" type="text" class="form-control" placeholder="Address" value="<?php echo $data -> addr; ?>">
                </div>
          ...
          <div class="card h-100">
            ...
            <div class="card-body p-3">
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item border-0 px-0">
                    <a href="?delaccount=perm" onclick="return confirm('Are You Sure You Want To Delete Your Account Permenantly ?')"> <i class="fa fa-trash"></i>&nbsp; Delete account </a>
                </li>
