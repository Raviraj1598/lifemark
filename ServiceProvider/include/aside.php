...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html" target="_blank">
        ...
        <span class="ms-1" style="font-size:25px"><font face="forte" >The Life Mark</font></span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link  <?php if($page=="booking"){ echo 'active'; } ?>" href="index.php">
            ...
            <span class="nav-link-text ms-1">Booking Requests</span>
          </a>
        </li>
      ...
      <a class="btn bg-gradient-primary mt-4 w-100" href="UpgradePro.php" type="button">Upgrade to pro</a>
    </div>
        <?php } ?>
        </li>
      </ul>
