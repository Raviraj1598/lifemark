<div class="row">
    ...
    <table class="table table-striped table-bordered bootstrap-datatable datatable responsive" style="font-size:10px">
    <thead>
    <tr>
        <th>ID</th>        
    ...
    <tbody>
	<?php
	$sel = "select * from booking_tb,serviceprovider_tb,user_tb,service_tb,category_tb where booking_tb.sp_id = serviceprovider_tb.sp_id and booking_tb.u_id = user_tb.u_id and booking_tb.s_id = service_tb.s_id and booking_tb.cat_id = category_tb.cat_id";
