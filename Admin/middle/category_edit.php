<?php
	$sel = "select * from category_tb where cat_id = '$_REQUEST[edt]'";
...
<div class="row">
            ...
            <div class="box-content">
                <form role="form" method="post">
                        ...
                        <label for="exampleInputEmail1">Category</label>
                         <input type="text" name="a1"  class="form-control" placeholder="Enter Name" value="<?php echo $v['cat_name'];?>" /> 					
                        </div>
	                    <div class="form-group">
    ...
    if(isset($_REQUEST['sub2']))
	{
					...
					$c = date('Y-m-d h:i:s');
                     ...
                     $ins = "update category_tb set cat_name = '$a',cat_status = '$b',cat_updated = '$c' where cat_id = '$_REQUEST[edt]' ";
